// Generic case study placeholder — reads window.CASE_SLUG
const CASES = {
  'atlas-repositioning': {
...
function CasePlaceholderApp() {
  ...
  React.useEffect(() => {
    if (data.client) {
      document.title = data.client + ' — Bhargava';
    }
  }, []);
        ...
        <section className="case-opener surface-ink on-dark">
          <div className="shell">
            ...
            <div className="case-placeholder__actions reveal" data-delay="340">
              <a href="work.html" className="btn">← Back to all work</a>
              <a href="contact.html" className="btn btn--ochre">Discuss a similar problem →</a>
            </div>
          </div>
        </section>
      </main>
...
ReactDOM.createRoot(document.getElementById('root')).render(<CasePlaceholderApp />);
