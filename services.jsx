  ...
  return (
    <>
      ...
      <main>
        ...
        {/* CS01 — Diagnostic featured card */}
        <section className="section-pad surface-linen" data-screen-label="02 Diagnostic">
          <div className="shell">
            <DiagnosticCard />
          </div>
        </section>
        ...
        {/* CS02 — Three stage cards */}
        <section className="section-pad-sm" data-screen-label="03 Stages">
          <div className="shell">
        ...
        {/* CS05 — Fit qualifier */}
        <section className="section-pad surface-paper" data-screen-label="04 Fit">
        ...
        {/* Final CTA close */}
        <section className="surface-dim on-dark section-pad" data-screen-label="05 CTA close">
          <div className="shell">
  ...
  return (
    <article className="dx-card reveal">
      ...
      <footer className="dx-card__foot">
        <a href="contact.html" className="btn btn--ochre">Start a diagnostic →</a>
